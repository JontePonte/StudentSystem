...
func _on_SaveButton_pressed():
	...
	student_dict = SaveFunc.save_student_info_active_check(student_dict, ActiveCheck)
	student_dict = SaveFunc.save_student_info_name(student_dict, FirstName, LastName)
